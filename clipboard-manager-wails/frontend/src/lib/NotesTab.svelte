...
<div class="tab-container">
    <div class="sidebar">
        ...
        <div class="note-list">
            {#each filteredNotes as note}
                <div class="note-item {selectedNote && selectedNote.id === note.id ? 'active' : ''}" 
    ...
    <div class="main-editor">
        {#if selectedNote}
            ...
            <textarea bind:value={editContent} placeholder="Write something..." class="content-input"></textarea>
        {:else}
...
<style>
  ...
  .note-item.active { background: #e0e7ff; }

  .note-title { font-weight: bold; font-size: 0.9em; margin-bottom: 3px; }
  .note-preview { font-size: 0.8em; color: #666; margin-bottom: 3px; }
  .note-date { font-size: 0.7em; color: #999; }
  ...
  .save-btn { background: #4f46e5; color: white; border-color: #4f46e5; }
  .delete-btn { color: #ef4444; border-color: #ef4444; margin-left: 5px;}
</style>
